...
internal sealed class ViewAction {
    ...
    data class InsertTable(val rows: Int, val columns: Int): ViewAction()
    data object AddTableRowBefore: ViewAction()
    data object AddTableRowAfter: ViewAction()
    data object RemoveTableRow: ViewAction()
    data object AddTableColumnBefore: ViewAction()
    data object AddTableColumnAfter: ViewAction()
    data object RemoveTableColumn: ViewAction()
    data object ToggleTableHeader: ViewAction()
    data object RemoveTable: ViewAction()
    data object MoveToNextCell: ViewAction()
    data object MoveToPreviousCell: ViewAction()
}
